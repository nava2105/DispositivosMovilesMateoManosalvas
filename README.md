...
python main.py
```
* Llenar los siguientes campos en la consola con los valores de la sesion
User Id: 
```copy
226279542
```
SessionID:
```copy
48100068349%3AGBOsHBNvG70dHx%3A14%3AAYijPaq_JiY4RRK8LZBmL_m4VVwkGXTQaCamLK3vk?
```
CSFR Token:
```copy
9lI9fM2XYsyFdCfdmX9n5?
```
Nota: ```Se elimino algunos caracteres de la SessionID y CSFR Token por seguridad de la cuenta```
## 2. Extraer: Nombre del seguido, Usuario (@), Biografia, Tipo de cuenta (personal / creador / empresa), Categoria (si existe), Numero de seguidores, Numero de seguidos, Enlace del perfil

Función ```get_following```
